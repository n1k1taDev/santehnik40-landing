<template lang="html">
  <section class="flex justify-center min-h-screen bg-white dark:bg-gray-800">
    <div class="container mx-auto px-6 py-8">
      <div class="lg:flex items-center">
        <div class="lg:w-1/2">
          <h2 class="text-gray-800 dark:text-gray-100 text-3xl font-bold">
            Who I am
          </h2>

          <p class="text-gray-500 dark:text-gray-400 lg:max-w-md mt-4">
            Hi I am jane , software engineer
            <a class="text-indigo-600 dark:text-indigo-400 font-bold" href="#"
              >@BakaTeam</a
            >
            , Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum in
            sed non alias, fugiat, commodi nemo ut fugit corrupti dolorem sequi
          ...
          <div class="flex items-center -mx-2 mt-6">
            <a class="mx-2" href="#" aria-label="Twitter">
              <svg
                class="fill-current text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 h-5 w-5"
